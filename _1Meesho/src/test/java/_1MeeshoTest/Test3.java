...
import Pages.Search2ndResultsPage;

public class Test3 extends Browser{
	
	   private HeaderPage headerPage;
	   private Search2ndResultsPage search2ndResultsPage;
	   ...
	   private String TestID;
		...
		public void creatingPOMObject()
		{
			...
			search2ndResultsPage = new Search2ndResultsPage(driver);
		}
		...
		public void selectTargetProduct() throws InterruptedException, IOException
		{
			...
			search2ndResultsPage.clickOnproduct();
